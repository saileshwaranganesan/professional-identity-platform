/*
 * SocialPlatformIcon Component
 *
 * Renders SVG icons for each supported social network platform.
 */

import type { SocialPlatform } from '@/domain/socialLinks'
...
export function SocialPlatformIcon({ platform, size = 18, className }: SocialPlatformIconProps) {
  const style = { width: size, height: size, flexShrink: 0, display: 'inline-block' }
